...
type_list=['Baozhangxiangmu', 'Jibing', 'Qingjing', 'Wenjian', 'Time', 'Jianejiaoqing', 'Jiaofeinianqi',
           ...
           'Jine', 'Yiyuandengji', 'Baoxianjin', 'Jibingzhonglei', 'Hetonghuifu', 'Baodanjiekuan', 'Mianpeie','Baoquanxiang']
...
jb=[e.replace('\n','').replace("'","").replace('(','').replace(')','') for e in open(PATH+'/data/Jibing.txt','r')] #疾病
...
bqx=[e.replace('\n','') for e in open(PATH+'/data/Baoquanxiang.txt','r')] #保全项

sent_sub = ' |？|。|，|（.*）|\\(.*\\)'
FAQ_dict={}
fr=open(PATH+'/data/标准FAQ问答.txt','r')
...
label_dict={'D1': '某种疾病是否在承保范围内', 'D3': '保障项目的责任免除详情', 'D4': '询问合同变更', 'D5': '保障项目如何申请理赔', 'D6': '询问犹豫期', 'D7': '询问保险责任',
            'D8': '询问合同恢复', 'D10': '询问保单借款', 'D11': '询问特别约定', 'D12': '询问合同终止', 'D13': '询问合同生效', 'D14': '询问宣告死亡', 'D15': '询问如实告知',
            'D16': '询问合同解除', 'D17': '询问保险期间', 'D18': '询问保费垫缴', 'D20': '询问受益人', 'D21': '询问体检或验尸',
            'D22': '询问未归还款项偿还',
            'D23': '询问合同构成', 'D24': '询问争议处理', 'D25': '询问投保年龄', 'D26': '询问适用币种', 'D27': '询问基本保险金额', 'D28': '询问合同种类', 'D29': '询问等待期',
            'D30': '询问减额缴清', 'D31': '询问缴费方式', 'D32': '询问缴费年期',
            'D34': '产品保哪些疾病', 'D35': '询问公司有哪些产品', 'D36': '询问宽限期定义',
            'D37': '询问产品优势', 'D39': '询问免赔额定义', 'D40': '询问保险费缴纳', 'D42': '询问诉讼时效', 'D43': '询问变更通讯方式',
            'D44': '询问保险金给付','D47':'咨询时间','D48':'患某疾病是否可以投保','D49':'保单借款的还款期限',
            'D50':'某种情景是否可以投保','D51':'保险种类的定义',"D52":'某情景是否在承保范围内','D53':'疾病种类的定义','D54':'保障项目的定义','D55':'得了某类疾病怎样申请理赔',
            'D56':'询问失踪处理','D57':'疾病种类包含哪些疾病','D58':'某疾病是否属于某疾病种类','D59':'询问信息误告','D60':'询问疾病种类包含哪些','D61':'某种疾病的预防',
            'D62':'某种疾病的高发区域','D63':'某种体检异常指标分析','D64':'某种体检异常指标定义','D65':'身体器官的构成','D66':'疾病发病原因','D67':'某项体检的包含项',
            'D68':'某平台使用方法','D69':'询问合同领取方式','D70':'投保途径','D71':'投保人和被保险人关系','D72':'区分疾病种类的标准','D73':'保障项目的年龄限制',
            'D74':'公司经营状况','D75':'投保的职业要求','D76':'购买某项保险产品有无优惠','D77':'某类险种的缴费方式','D78':'体检的时限要求','D79':'某渠道的投保流程',
            'D80':'保费核算','D81':'理赔渠道申请流程','D82':'某产品的最低保额','D83':'咨询时间','D84':'理赔后缓缴保险费的处理办法','D85':'申请某保障项目所需资料',
            'D86':'公司股东构成','D87':'不同保障项目的重复理赔','D88':'询问产品价格','D89':'询问公司介绍','D90':'产品是否属于某一类险','D91':'承保区域','D92':'保障项目的赔付次数',
            'D93':'保费支付渠道','D94':'财务问卷针对的对象','D95':'疾病种类治疗费用','D96':'特殊人群投保规则','D97':'推荐保额','D98':'核保不通过解决办法',
            'D99':'体检标准','D100':'投保所需资料','D101':'询问保险条款','D102':'理赔医院','D103':'保障项目的赔付','D104':'险种介绍','D105':'产品推荐',
            'D106':'工具的使用限制','D107':'保险类型判断','D108':'诊断报告的领取','D109':'某人购买产品是否有优惠','D110':'产品升级介绍','D111':'体检指引',
            'D112':'询问保险金额','D113':'某情景是否具备购买产品资格','D114':'询问疾病种类的生存期','D115':'理赔的地域限制','D116':'保单借款的还款期限',
            'D117':'特殊人群投保限额','D118':'权益间的关系','D119':'保障项目的保障范围','D120':'产品介绍','D121':'申请纸质合同','D122':'疾病种类的赔付流程',
            'D123':'理赔速度','D124':'产品保障的地域限制','D125':'合同丢失','D126':'电子合同介绍','D127':'保单查询','D128':'理赔条件','D129':'赔付方式',
            'D130':'投保指引','D131':'业务办理提交材料','D132':'投保人与被保险人关系','D133':'投保人条件限制','D134':'红利申请规定','D135':'合同自动终止的情景',
            'D136':'理赔报案的目的','D137':'险种关联选择申请资料','D138':'变更投保人','D139':'查询方式','D140':'得了某个疾病怎样申请理赔',
            'D141':'疾病是否赔某个保障项目','D142':'情景是否赔偿某个保障项目','D143':'情景的定义','D144':'疾病的定义','D145':'询问保险事故通知','D146':'疾病包含哪些疾病',
            'D147':'如何申请某项服务','D148':'释义项的定义','D149':'询问分公司联系方式','D150':'询问复效期','D151':'询问赔付比例','D152':'询问投保规则',
            'D153':'询问保额累计','D154':'询问投保人','D155':'询问变更缴费方式','D300':'询问附加险','D157':'询问专科医生','D158':'询问现金价值',
            'D160':'询问投保书填写','D161':'询问增值服务内容','D162':'询问保险种类','D163':'询问免赔额数值','D164':'某种疾病是否在承保范围内',
            'D165':'复效期有无收取滞纳金','D166':'减额缴清的影响','D167':'询问保险金额','D168':'险种的年龄限制','D169':'某种疾病是否在承保范围内','D170':'高发疾病',
            'D171':'询问保险期间','D172':'忘记交保费的解决办法','D173':'保险是否有购买限制','D174':'理赔申请后出现特殊情况的解决办法','D175':'豁免保费后保单是否存在现金价值',
            'D176':'投保渠道的月缴首期','D177':'保障项目给付一半后的处理方法','D178':'特殊人群的理赔方式','D179':'国外医院的要求','D180':'保障项目如何申请理赔',
            'D181':'投资连结保险投资账户介绍','D182':'保险产品的定义','D183':'询问某产品增值服务项目','D184':'询问包含产品','D185':'询问合作医院','D186':'某产品的最低保额',
            'D187':'询问保险金额','D188':'询问宽限期时间','D189':'询问公司定义','D190':'询问险种免赔额数值','D191':'险种推荐','D192':'咨询引导','D193':'保费支出',
            'D194':'公司地址','D195':'询问联系方式','D196':'询问合作银行','D197':'商业保险与医保的关系','D198':'申请保单回溯',
            'D199':'某体检的意义','D200':'中信银行','D33':'服务内容介绍','D201':'询问保险产品','D202':'保险产品对比','D203':'疾病治疗费用','D204':'保费核算',
            'D205':'增值服务使用次数','D206':'增值服务使用时间','D207':'增值服务亮点','D208':'询问保险责任','D209':'产品续保','D210':'产品期满返还',
            'D211':'产品费用与报销','D212':'询问诉讼时效','D213':'变更保险金额','D214':'某情景下全残或身故赔偿','D215':'保障项目保哪些疾病','D216':'询问免责条款',
            'D217':'不能豁免','D218':'理赔需要的材料','D219':'可以豁免','D220':'免赔额抵扣','D221':'理赔规则','D222':'多次赔付'}
...
class intent_detection(object):
    ...
    def DD(self,sent:str,id:int)->str:
        ...
        if id==48:
            ...
            pattern='(%s|%s).*(保|保不保|投保|购?买)|保.*(%s)'%(self.jbhzs,self.jbs,self.jbs)
        ...
        if id==65:
            #身体器官的构成
            pattern = '(%s).*(构成|结构)'%self.sts
            if [e for e in self.sents if e in st] and re.search(pattern, sent):
                return 'D65'
        if id==66:
            #疾病发病原因
        ...
        if id==67:
            #某项体检的包含项
            pattern = '(%s).*(包括|包含|有哪些)'%self.tjxms
            if  re.search(pattern, sent):
                return 'D67'
        if id==68:
            #某平台使用方法
            ...
            pattern_no='申请流程'
            if [e for e in self.sents if e in pt] and re.search(pattern, sent) and  not re.search(pattern_no,sent):
                return 'D68'
        if id==69:
            #询问合同领取方式
            pattern='合同.*领?[取|拿]'
...
if __name__ == '__main__':
    from intent_de.intent_sys import Tree
